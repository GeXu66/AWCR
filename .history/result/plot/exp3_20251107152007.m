...
% subplot label (b)
ax2 = gca;
text(ax2, 0.01, 0.95, '(b)', 'Units','normalized', 'FontSize', label_fontsize, 'FontWeight','bold', 'Clipping','off');
...
% subplot label (c)
text(axL, 0.01, 0.95, '(c)', 'Units','normalized', 'FontSize', label_fontsize, 'FontWeight','bold', 'Clipping','off');
...
% subplot label (d)
text(axR, 0.01, 0.95, '(d)', 'Units','normalized', 'FontSize', label_fontsize, 'FontWeight','bold', 'Clipping','off');
