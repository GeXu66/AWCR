...
% (2) Condition IDs over time (piecewise-constant) with markers every 5 s
nexttile;
...
axTmp = nexttile; delete(axTmp);
t3 = tiledlayout(fig, 1, 2, 'TileSpacing', 'compact', 'Padding', 'compact');
t3.Layout.Tile = 3;
