...
text(0.02, 0.05, '(a)', 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
xlim([0, max(t1)]);
grid on;
...
text(0.02, 0.05, '(d)', 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
grid on;
