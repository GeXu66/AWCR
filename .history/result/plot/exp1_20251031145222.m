...
% Figure and panels
fig = figure('Color', 'w', 'Position', [200 200 600*1.5 300*1.5]);
...
xlabel('Time (s)', 'FontSize', label_fontsize); ylabel('$F_z$', 'Interpreter', 'latex', 'FontSize', label_fontsize); legend({'Measured', 'Estimated'}, 'Location', 'southeast', 'FontSize', legend_fontsize);
...
xlabel('Time (s)'); ylabel('$F_z$', 'Interpreter', 'latex'); legend({'Measured', 'Estimated'}, 'Location', 'southeast');
...
xlabel('Time (s)'); ylabel('|Error|'); legend({'BC50\_01', 'BC50\_02'}, 'Location', 'northeast');
...
xlabel('Time (s)'); ylabel('$F_z$', 'Interpreter', 'latex'); legend({'Measured', 'Estimated'}, 'Location', 'northeast');
