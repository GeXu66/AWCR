...
% Subplot label (a) outside top-left
axA = gca;
text(axA, -0.08, 1.08, '(a)', 'Units', 'normalized', 'FontSize', label_size, 'FontWeight', 'bold', 'Clipping', 'off');
...
axB = gca;
text(axB, -0.12, 1.05, '(b)', 'Units', 'normalized', 'FontSize', label_size, 'FontWeight', 'bold', 'Clipping', 'off');
...
axC = gca;
text(axC, -0.10, 1.05, '(c)', 'Units', 'normalized', 'FontSize', label_size, 'FontWeight', 'bold', 'Clipping', 'off');
