...
text(0.02, 0.05, '(b)', 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
xlim([0, max(t1)]);
grid on;
...
text(0.02, 0.05, '(c)', 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
