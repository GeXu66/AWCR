...
xlim([0, max(t1)]);
grid on;
text(0.02, 0.95, sprintf('MAPE(BC50\\_01)=%.1f%%,\n MAPE(BC50\\_02)=%.1f%%', fz_mape1, fz_mape2), 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
text(0.02, 0.85, sprintf('MAPE(BC50\\_02)=%.1f%%', fz_mape1, fz_mape2), 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top');
