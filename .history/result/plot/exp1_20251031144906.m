...
% Figure and panels
fig = figure('Color', 'w', 'Position', [200 200 600 300]);
...
xlabel('Time (s)'); ylabel('F_z'); legend({'Measured', 'Estimated'}, 'Location', 'southeast');
...
nexttile;
stem(t1, e1, 'Color', [0.85 0.33 0.10], 'LineWidth', 1.2); hold on;
stem(t2, e2, 'Color', [0.49 0.18 0.56], 'LineWidth', 1.2);
...
xlabel('Time (s)'); ylabel('F_z'); legend({'Measured', 'Estimated'}, 'Location', 'northeast');
