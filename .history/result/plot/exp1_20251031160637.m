...
xlim([0, max(t1)]);
text(0.02, 0.90, sprintf('MAPE=%.1f%%', fz_mape2), 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontSize', legend_fontsize);
xlim([0, max(t1)]);
grid on;
...
xlim([0, max(t3)]);
text(0.02, 0.90, sprintf('MAPE=%.1f%%', fz_mape3), 'Units', 'normalized', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontSize', legend_fontsize);
xlim([0, max(t3)]);
grid on;
