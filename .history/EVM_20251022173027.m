...
% 标出 A 与问号
text(-0.5,-0.1,0,'A','FontWeight','bold','FontSize',20,'Color','k');
text( 0.25, 0.35,0,'??','FontWeight','bold','FontSize',22,'Color','k');
text( 2.90,-0.05,0,'?','FontWeight','bold','FontSize',22,'Color','k');
