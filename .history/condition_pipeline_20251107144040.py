...
from feature_library import build_feature_library, compute_feature_for_name, extract_condition_prefix, compute_feature_for_segment
...
def pipeline_exp3(trainlist: List[List[str]],
    ...
    for k in range(num_segs):
        ...
        feat = compute_feature_for_segment(Zabs, x_1d)
